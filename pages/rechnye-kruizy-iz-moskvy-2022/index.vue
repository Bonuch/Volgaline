<template>
    <div class="page-inner page-river-cruises-2022">
        <div class="page-inner__content">
            <div class="header-cruise py-12 flex items-end justify-end mb-10 relative bg-no-repeat bg-center bg-cover">
                <picture class="w-full h-full absolute left-0 top-0 z-0">
                    <img class="object-cover w-full h-full" alt="Москва" src="~/assets/images/inner/iz-moskvy-2022.jpeg">
                </picture>
                <div class="wrapper-bg text-white">
                    <div class="header-title__container">
                        <h1 class="header-cruise-title m-0 font-bold text-4xl md:text-2xl">
            ...
            <div class="wrapper wrapper-1410">
                <h2>Подберите свой круиз сами</h2>
