<template>
    <div class="page-inner page-akcii-na-navigacii">
        <div class="page-akcii-na-navigacii-banner pt-6 pb-32 text-white">
            ...
            <div class="wrapper px-64 3xl:px-10 tablet:px-10 sm:px-4 sm:mb-4">
                <h1 class="leading-tight text-white mb-10 sm:mb-5 rounded-sm sm:p-2  text-purple-500  text-50 md:text-40 sm:text-25 mob:text-22">
                    <span class="py-2 pr-6 font-normal block">Дорогие женщины!</span>
                    <span class="py-2 pr-6 font-normal block">Поздравляем Вас с 8 марта!</span>
                    <span class="py-2 pr-6 font-normal block">Дарим скидку до 21%</span>
                </h1>
            </div>
        </div>
        ...
        <div class="page-inner__content">
            <section class="section-happyness py-20 mb-23 bg-gray-50 sm:py-0 sm:bg-white">
                ...
                <div class="wrapper wrapper-1410">
                    ...
                    >
                        Успейте воспользоваться нашими акциями и запланируйте интересный отпуск по <span class="text-purple-500 font-bold">"старым"</span> ценам уже сейчас!
                    </div>
...
const pageTitle = 'Скидка 21% в честь 8 марта';
...
.page-akcii-na-navigacii {
    &-banner {
        background: #6CE7A4 url('/images/inner/8_march_desctop.jpg') no-repeat center top / cover;
    }
...
@screen sm {
    .page-akcii-na-navigacii {
        &-banner {
            background: url('/images/inner/8_march_mobile.jpg') no-repeat center top / cover;
        }
    }
}
</style>
