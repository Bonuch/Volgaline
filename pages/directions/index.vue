<template>
    <div class="page-inner page-directions pt-6 pb-14">
        <div class="wrapper">
            ...
            <p v-else>Направлений в данный момент - нет.</p>

            <button
                v-if="fsrShowMoreVisibility"
                type="button"
                class="button button-transparent button-show-more"
                @click="fsrOnSearchMoreClick('/directions')"
            >
                Показать еще
            </button>
        </div>
...
<script>
    ...
    const pageTitle = "Список направлений";
        ...
        head() {
            return {
                ...
                meta: [
                    ...
                    { hid: "keywords", name: "keywords", content: 'Волгалайн: Направления «Волгалайн». Речные круизы в России - «Волгалайн». Cписок речных направлений Волгалайн' },
                    { hid: "description", name: 'description', content: 'Волгалайн: Направления «Волгалайн». Речные круизы в России - «Волгалайн». Cписок речных направлений Волгалайн' },
                    { hid: "og:title", property: "og:title", content: this.getPageTitle() },
                    { hid: "og:type", property: "og:type", content: 'website' },
                    { hid: "og:description", property: "og:description", content: "Волгалайн: Направления «Волгалайн». Речные круизы в России - «Волгалайн». Cписок речных направлений Волгалайн" },
        ...
        jsonld() {
            if (this.fsrContent && Object.keys(this.fsrContent).length > 0) {
                return {
                    ...
                    "keywords": 'Волгалайн: Направления «Волгалайн». Речные круизы в России - «Волгалайн». Cписок речных направлений Волгалайн',
                    "description": 'Волгалайн: Направления «Волгалайн». Речные круизы в России - «Волгалайн». Cписок речных направлений Волгалайн',
                    "url": this.getPageUrl,
                };
            } else {
                return null;
