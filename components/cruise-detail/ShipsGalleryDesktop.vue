<template>
    <div class="ships-gallery-desktop ships-gallery swiper-container">
        <div class="swiper-wrapper">
            <a
                v-for="(item, idx) in gallery"
                :key="idx"
                :href="item.image_url"
                class="swiper-slide cruise-detail-ship__gallery-item image-loop-hover rounded-sm overflow-hidden"
            >
            ...
            initSwiper() {
                ...
                if ($el) {
                    const bannersSwiper = new Swiper($el, {
                        ...
                        loop: true,
                        navigation: {
                            prevEl: ".ships-gallery-desktop .ships-gallery__btn.swiper-button-prev",
                            nextEl: ".ships-gallery-desktop .ships-gallery__btn.swiper-button-next",
                        },
                    });
                }
            },
