<template>
    <div class='cruise-deck-scheme-marking flex items-center'>
        <div class='cruise-deck-scheme-marking-title w-28 mr-7 text-lg leading-tight xl:text-base xl:leading-snug sm:w-full sm:m-0 sm:mb-5'>
            Маркировка кают
        </div>

        <div class="cruise-deck-scheme-marking-list flex items-center sm:block">
