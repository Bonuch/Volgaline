        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div
                    v-for="(item) in arr"
                    :key="item.id"
                    class="swiper-slide discounts-promotions-slide rounded-sm overflow-hidden"
                >
                    ...
                    <div class="discounts-promotions-content flex flex-col rounded-b">
                        <p v-if="item.title" class="line-clamp-2 text-blue-700 text-lg font-medium mb-3 h-auto">
                            <nuxt-link :to="{
                                    path: item.link? item.link: '',
                            }">
                                {{item.title}}
                        ...
                        <p v-if="item.text" class="line-clamp-3 font-medium mb-0 leading-5">{{item.text}}</p>
