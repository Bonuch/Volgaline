<template>
    <div>
        <div class="header-cruise py-12 flex flex-col items-start mb-10 relative bg-no-repeat bg-center bg-cover">
            ...
            <div class="w-full wrapper absolute wrapper-1410 mt-10 z-10">
...
const cruiseQueryMamin =  {
    ...
    departure_date_from: '14.06.2022',
    departure_date_to: '25.06.2022',
    limit: 100,
};
const cruiseQueryMaminSeptember =  {
    ships: '54', // Мамин-сибиряк
    departure_date_from: '01.09.2022',
    departure_date_to: '30.04.2023',
    limit: 100,
};

export default {
    name: "AkciiPromoPageSort",
