<template>
    ...
    >
        ...
        <div class="wrapper wrapper-1410 flex items-center justify-between xl:block md:px-6">
            <h2 class="m-0 text-44 text-white mr-12" v-html="title"></h2>
