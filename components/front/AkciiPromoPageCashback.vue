<template>
    <div>
        <div class='header-cruise py-12 flex flex-col items-start mb-10 relative bg-no-repeat bg-center bg-cover xs:pt-7 xs:pb-28'>
            <picture
            ...
            <div class='w-full wrapper wrapper-1410 mt-10 z-10 xs:mt-0'>
...
import { findSearchParamsFromSeoFileds, findSeoFieldByCode } from '@/helpers/cruises';

export default {
    name: "AkciiPromoPageCashback",
    ...
    async asyncData(context) {
        ...
        try {
            ...
            if (akciiData.seo) {
                cruiseQuery = findSearchParamsFromSeoFileds(akciiData.seo);
                params = sfmPrepearFormData(cruiseQuery, context.$dayjs);
            }
        } catch (ex) {
            console.log("cant find content: " + ex);
