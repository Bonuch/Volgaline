...
import TotalItemCabinForAgent from "./TotalItemCabinForAgent";

export default {
    name: "CruisesOrderForAgent",
    components: { TotalItemCabinForAgent},
